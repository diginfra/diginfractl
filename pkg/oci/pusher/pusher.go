...
import (
	...
	"github.com/diginfra/diginfractl/pkg/oci/repository"
...
func (p *Pusher) Push(ctx context.Context, artifactType oci.ArtifactType,
	...
	p.workingDir, err = os.MkdirTemp("", "diginfractl")
	if err != nil {
		return nil, err
	}
...
func (p *Pusher) storeMainLayer(ctx context.Context, fileStore *file.Store,
	...
	switch artifactType {
	case oci.Rulesfile:
		layerMediaType = oci.DiginfraRulesfileLayerMediaType
	case oci.Plugin:
		layerMediaType = oci.DiginfraPluginLayerMediaType
	case oci.Asset:
		layerMediaType = oci.DiginfraAssetLayerMediaType
	default:
...
func (p *Pusher) storeConfigLayer(ctx context.Context, fileStore *file.Store,
	...
	switch artifactType {
	case oci.Rulesfile:
		layerMediaType = oci.DiginfraRulesfileConfigMediaType
	case oci.Plugin:
		layerMediaType = oci.DiginfraPluginConfigMediaType
	case oci.Asset:
		layerMediaType = oci.DiginfraAssetConfigMediaType
	default:
	...
	// See: https://github.com/diginfra/diginfractl/issues/302
...
func (p *Pusher) toFileStore(ctx context.Context, fileStore *file.Store, mediaType, name string, data interface{}) (desc *v1.Descriptor, err error) {
	...
	configFile, err := os.CreateTemp(p.workingDir, "diginfractl")
	if err != nil {
		return nil, err
	}
	defer func() {
...
func (p *Pusher) packManifest(ctx context.Context, fileStore *file.Store,
	...
	if dataDesc.MediaType == oci.DiginfraPluginLayerMediaType {
