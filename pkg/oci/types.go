...
import (
	...
	"github.com/diginfra/diginfractl/pkg/artifact"
)
...
func (e *ArtifactType) ToMediaType() string {
	switch *e {
	case Rulesfile:
		return DiginfraRulesfileLayerMediaType
	case Plugin:
		return DiginfraPluginLayerMediaType
	case Asset:
		return DiginfraAssetLayerMediaType
	}
...
func HumanReadableMediaType(s string) string {
	switch s {
	case DiginfraRulesfileLayerMediaType:
		return string(Rulesfile)
	case DiginfraPluginLayerMediaType:
		return string(Plugin)
	case DiginfraAssetLayerMediaType:
		return string(Asset)
	}
