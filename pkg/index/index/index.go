...
import (
	...
	"github.com/diginfra/diginfractl/pkg/index/config"
...
//     e.g "cloudtrail" -> "ghcr.io/diginfra/plugins/cloudtrail:latest"
...
//     e.g "cloudtrail:0.5.1" -> "ghcr.io/diginfra/plugins/cloudtrail:0.5.1"
//     e.g "cloudtrail@sha256:123abc..." -> "ghcr.io/diginfra/plugins/cloudtrail@sha256:123abc...
//
//  2. if name is a reference without tag or digest, tag latest is appended.
//     e.g. "ghcr.io/diginfra/plugins/cloudtrail" -> "ghcr.io/diginfra/plugins/cloudtrail:latest"
//
