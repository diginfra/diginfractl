...
Usage:
  diginfractl driver config [flags]

Flags:
  -h, --help                help for config
      --kubeconfig string   Kubernetes config.
      --namespace string    Kubernetes namespace.
      --update-diginfra        Whether to update Diginfra config/configmap. (default true)
...
Global Flags:
      ...
      --name string            Driver name to be used. (default "diginfra")
      --repo strings           Driver repo to be used. (default [https://download.diginfra.org/driver])
