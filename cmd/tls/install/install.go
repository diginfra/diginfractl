...
import (
	...
	"github.com/diginfra/diginfractl/pkg/install/tls"
...
func NewTLSInstallCmd(opt *commonoptions.Common) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:                 "Generate and install TLS material to be used with the Diginfra gRPC server",
		Long: `Diginfra gRPC server runs with mutually encrypted TLS by default.
