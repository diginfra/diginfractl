...
var (
	// Semantic version that refers to ghe version (git tag) of Diginfractl that is released.
...
func NewVersionCmd(opt *commonoptions.Common) *cobra.Command {
	o := options{
		Common: opt,
	}
	...
	cmd := &cobra.Command{
		Use:   "version",
		Short: "Print the diginfractl version information",
		Long:  "Print the diginfractl version information",
		Args:  cobra.NoArgs,
